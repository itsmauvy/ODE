const productData = {
  '1': {
    ...
    colors: [
      { label: '피그 무스',     color: '#c47a7a', images: ['images/ode pocket blush_close.png', 'images/ode pb model.png'] },
      { label: '코코넛 블러쉬', color: '#e8b4a0', images: ['images/coconut pocket blush 1.png', 'images/coconut blush_model.jpg'] },
