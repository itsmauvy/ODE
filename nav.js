...
const megaProducts = [
  ...
  { id:'4', name:'COCONUT BREEZE',      sub:'Coconut Body Mist',    desc:'Scented Body Mist',    img:'images/ode body mist_nobg.png',           cat:['all','body','new'],   badge:'', ko:'코코넛 브리즈 바디미스트 미스트 바디'                                          },
